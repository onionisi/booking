...
var referer = 'http://m.kuaishubao.com/m/member/my_order_fav.php';
</script>
</head>
<body>
    ...
    <div class="m-hd">
		...
		<div class='m-login'>
			...
			<div class='f-mt20 login-weibo'>
				...
				<button class='u-btn-red u-btn-fullwd u-txt-white18' url_to="/member/other_login.php?from=1&client=1&src=http%3A%2F%2Fm.kuaishubao.com%2Fm%2Fmember%2Fmy_order_fav.php">用微博账号登录</button>
			</div>
			
			<div class='reg-div'>
				<div>还不是会员？<button class='u-btnbox40' url_to="/m/member/reg.php?src=http%3A%2F%2Fm.kuaishubao.com%2Fm%2Fmember%2Fmy_order_fav.php">立即注册</button></div>
			</div>
