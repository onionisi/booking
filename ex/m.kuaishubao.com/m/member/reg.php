...
-->
<script language="javascript" src="../../js/m/member/reg.js?v=1"></script>
<script language="javascript">
var referer = 'http://m.kuaishubao.com';
</script>
</head>
<body>
    ...
    <div class="m-hd">
		...
		<div class='u-box m-ipt-group2'>
			<ul id="reg_ul">
				...
				<li>
					<input type="text" placeholder='邮箱' name="email" id="email" value="">
				</li>
			</ul>
		</div>
		<div class='m-login'>
			<button class='u-btn-blue u-btn-fullwd u-txt-white18' id="reg_form_submit_btn">注册</button>
			<div class='f-mt20 login-weibo'>
				<p class='f-lh2em'>使用合作网站账号登录快书包：</p>
				<button class='u-btn-red u-btn-fullwd u-txt-white18' url_to="/member/other_login.php?from=1&client=1&src=http%3A%2F%2Fm.kuaishubao.com">用微博账号登录</button>
			</div>
			<div class='login-div'>
				<div>已是快书包会员？<button class='u-btnbox40' url_to="/m/member/login.php?src=http%3A%2F%2Fm.kuaishubao.com">登录</button></div>
			</div>
		</div>
